...
<form METHOD="POST" ACTION="https://backoffice.iveri.co/Lite/Authorise.asp" id="aForm" name="aForm">
<center>
...
<!-- Lite -->
    <tr>
        ...
        <td align="left">
           <input  type="hidden"  id="Lite_Merchant_ApplicationID" name="Lite_Merchant_ApplicationID" value="" size="45" />
         </td>
    </tr>
			...
			<!-- products -->
				...
				<!--
							...
							development or debugging.
														-->
			   <input type="hidden" name="Lite_Website_Successful_url" value="http://localhost:8181/result.php?Result=Success" /> <!-- NEED TO BE CHANGED -->
		<input type="hidden" name="Lite_Website_Fail_url" value="http://localhost:8181/result.php?Result=Fail" /> <!-- NEED TO BE CHANGED -->
		<input type="hidden" name="Lite_Website_TryLater_url" value="http://localhost:8181/result.php?Result=TryLater" /> <!-- NEED TO BE CHANGED -->
		<input type="hidden" name="Lite_Website_Error_url" value="http://localhost:8181/result.php?Result=Error" /> <!-- NEED TO BE CHANGED -->
			<!-- Ecml start-->
